...
[![Wercker](https://img.shields.io/badge/version-V1.1.0-brightgreen.svg)]()
...
compile 'io.github.clendy.leanback:v14leanback:1.1.0'
```
...
Or Ivy:
```groovy
<dependency org='io.github.clendy.leanback' name='v14leanback' rev='1.1.0'>
