...
import io.github.clendy.leanback.widget.VerticalLoadMoreGridView;
 ...
 */
public class VerticalActivity extends BaseFragmentActivity<VerticalPresenter> implements IView,
    ...
    VerticalLoadMoreGridView mRecyclerView;
    ...
    private void initRecyclerView() {
        ...
        mRecyclerView.setOnChildSelectedListener(new OnChildSelectedListener() {
            ...
            public void onChildSelected(ViewGroup parent, View view, int position, long id) {
                ...
                if (mRecyclerView.isFocusOnBottomRow(view, position)) {
