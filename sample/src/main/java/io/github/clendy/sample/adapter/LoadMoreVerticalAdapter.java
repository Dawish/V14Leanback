 ...
 */
public class LoadMoreVerticalAdapter extends RecyclerView.Adapter<LoadMoreVerticalAdapter.ViewHolder> {
    ...
    public LoadMoreVerticalAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_VIEW_TYPE_HEADER) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.item_layout_big, parent, false);
            return new ViewHolder(view, ITEM_VIEW_TYPE_HEADER);
        } else {
